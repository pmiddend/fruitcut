#ifndef FRUITCUT_STRING_TO_DURATION_EXN_HPP_INCLUDED
#define FRUITCUT_STRING_TO_DURATION_EXN_HPP_INCLUDED
	...
	std::basic_string<Char,Traits> const &input_string)
{
	...
	if(!result)
		throw exception(FCPPT_TEXT("\"")+input_string+FCPPT_TEXT("\" is not a valid time string"));
