...
fruitcut::app::highscore::post_model::connection_wrapper::connection_wrapper(
...
fruitcut::app::highscore::provider::connection_base &
fruitcut::app::highscore::post_model::connection_wrapper::connection()
{
	return 
		*connection_;
}
...
fruitcut::app::highscore::post_model::post_model(
...
fruitcut::app::highscore::post_model::message_received(
...
fcppt::signal::auto_connection
fruitcut::app::highscore::post_model::error_received(
...
void
fruitcut::app::highscore::post_model::post(
...
void
fruitcut::app::highscore::post_model::update()
{
	for(
...
fruitcut::app::highscore::post_model::columns() const
{
	return 
...
fcppt::signal::auto_connection
fruitcut::app::highscore::post_model::row_added(
...
fcppt::signal::auto_connection
fruitcut::app::highscore::post_model::row_removed(
...
void
fruitcut::app::highscore::post_model::message_received_internal(
...
void
fruitcut::app::highscore::post_model::error_received_internal(
	provider::object_base const &_provider,
	fcppt::string const &_message)
{
	error_received_(
...
void
fruitcut::app::highscore::post_model::rank_received_internal(
	provider::object_base const &_provider,
