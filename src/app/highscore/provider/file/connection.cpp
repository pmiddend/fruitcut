...
fruitcut::app::highscore::provider::file::connection::connection(
...
void
fruitcut::app::highscore::provider::file::connection::retrieve_list()
{
	sge::parse::json::object result;
	if(!sge::parse::json::parse_file(path_,result))
	{
...
void
fruitcut::app::highscore::provider::file::connection::update()
{
}

fcppt::signal::auto_connection
fruitcut::app::highscore::provider::file::connection::message_received(
...
fcppt::signal::auto_connection
fruitcut::app::highscore::provider::file::connection::error_received(
...
fcppt::signal::auto_connection
fruitcut::app::highscore::provider::file::connection::list_received(
...
fcppt::signal::auto_connection
fruitcut::app::highscore::provider::file::connection::rank_received(
