...
fruitcut::app::highscore::gui_model::gui_model()
:
	row_added_(),
	row_removed_(),
	current_entry_set_()
...
fruitcut::app::highscore::gui_model::columns() const
{
	return
...
fruitcut::app::highscore::gui_model::row_added(
...
fcppt::signal::auto_connection
fruitcut::app::highscore::gui_model::row_removed(
...
void
fruitcut::app::highscore::gui_model::reset(
