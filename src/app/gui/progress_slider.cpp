...
namespace
{
fruitcut::app::gui::progress_slider::value_type const increase_amount = 
	static_cast<fruitcut::app::gui::progress_slider::value_type>(
		0.1);
}

fruitcut::app::gui::progress_slider::progress_slider(
...
fruitcut::app::gui::progress_slider::value_changed(
...
void
fruitcut::app::gui::progress_slider::increase_callback()
{
	progress_window_.setProgress(
		std::min(
...
void
fruitcut::app::gui::progress_slider::decrease_callback()
{
	progress_window_.setProgress(
		std::max(
			static_cast<value_type>(
