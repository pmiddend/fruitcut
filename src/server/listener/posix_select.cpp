...
fruitcut::server::listener::posix_select::posix_select(
	short const port,
...
void
fruitcut::server::listener::posix_select::run_once()
{
	fd_set read_fds = 
		master_read_fds_;
...
void
fruitcut::server::listener::posix_select::client_connect(
...
void
fruitcut::server::listener::posix_select::client_receive_data(
...
void
fruitcut::server::listener::posix_select::client_disconnect(
...
void
fruitcut::server::listener::posix_select::send(
	int const _fd,
...
void
fruitcut::server::listener::posix_select::handle_read(
	int const fd)
{
	...
	if(client_receive_data_)
		client_receive_data_(
			...
			server::byte_sequence(
				reinterpret_cast<server::byte_sequence::value_type const *>(
					&buffer[0]),
				reinterpret_cast<server::byte_sequence::value_type const *>(
...
void
fruitcut::server::listener::posix_select::handle_write(
	int const fd)
{
	...
	fd_string_pair->second.erase(
		...
		fd_string_pair->second.begin() + 
			static_cast<server::byte_sequence::difference_type>(
				bytes_sent));
