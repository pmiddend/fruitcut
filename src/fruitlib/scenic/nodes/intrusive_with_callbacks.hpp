#ifndef FRUITCUT_FRUITLIB_SCENIC_NODES_INTRUSIVE_WITH_CALLBACKS_HPP_INCLUDED
#define FRUITCUT_FRUITLIB_SCENIC_NODES_INTRUSIVE_WITH_CALLBACKS_HPP_INCLUDED
