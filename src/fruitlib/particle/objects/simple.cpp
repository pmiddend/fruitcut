...
fruitcut::fruitlib::particle::objects::simple<Choices>::simple(
...
template<typename Choices>
void
fruitcut::fruitlib::particle::objects::simple<Choices>::update()
{
...
template<typename Choices>
bool 
fruitcut::fruitlib::particle::objects::simple<Choices>::dead() const
{
...
template<typename Choices>
void
fruitcut::fruitlib::particle::objects::simple<Choices>::velocity(
	sge::renderer::vector2 const &_velocity)
{
	velocity_ = _velocity;
}
...
template<typename Choices>
void
fruitcut::fruitlib::particle::objects::simple<Choices>::acceleration(
	sge::renderer::vector2 const &_acceleration)
{
...
template class fruitcut::fruitlib::particle::objects::simple<fruitcut::fruitlib::particle::sprite::choices>;
template class fruitcut::fruitlib::particle::objects::simple<fruitcut::fruitlib::particle::point_sprite::choices>;
