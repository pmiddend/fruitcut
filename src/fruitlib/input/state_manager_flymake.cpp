...
fruitcut::fruitlib::input::state_manager::state_manager(
...
void
fruitcut::fruitlib::input::state_manager::current_state(
	state &_current_state)
{
	current_state_ = &_current_state;
}

fruitcut::fruitlib::input::state const *
fruitcut::fruitlib::input::state_manager::current_state() const
{
...
void
fruitcut::fruitlib::input::state_manager::add(
	input::state const &)
{
}

void
fruitcut::fruitlib::input::state_manager::remove(
	input::state const &s)
{
	if (&s == current_state_)
		current_state_ = 0;
...
void
fruitcut::fruitlib::input::state_manager::key_callback_internal(
...
void
fruitcut::fruitlib::input::state_manager::char_callback_internal(
...
void
fruitcut::fruitlib::input::state_manager::mouse_axis_callback_internal(
...
void
fruitcut::fruitlib::input::state_manager::mouse_button_callback_internal(
