...
:
	...
	shader_(
		sge::shader::object_parameters(
			...
			.vertex_shader(
				fruitlib::media_path()/FCPPT_TEXT("shaders")/FCPPT_TEXT("shadow_map")/FCPPT_TEXT("vertex.glsl"))
			.fragment_shader(
				fruitlib::media_path()/FCPPT_TEXT("shaders")/FCPPT_TEXT("shadow_map")/FCPPT_TEXT("fragment.glsl"))),
	mvp_(
		_mvp)
{
}
